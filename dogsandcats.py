...
Original file is located at
    https://colab.research.google.com/drive/1yItNwoPf0ru-eg68ilvWBE4gUfyYdTSp

# Getting the dataset and unzipping it
"""

from google.colab import drive
drive.mount('/content/gdrive')

!unzip gdrive/My\ Drive/catsdogs/dogs-vs-cats.zip
!unzip /content/train.zip
!unzip /content/test1.zip

"""# Plotting dogs and cats pictures
...
def summarize_diagnostics(history, name):
  ...
  with open('/output.txt', 'a') as writefile:
    writefile.write(str(history.history) + '\n')
  ...
  pyplot.savefig(filename + '_plot' + name + '.png')
  pyplot.close()
...
# run the test harness for evaluating a model
def run_test_harness_final(model_to_use, name):
  # define model
  model = model_to_use
  # create data generator
  ...
  # fit model
  his = model.fit(train_it, steps_per_epoch=len(train_it), epochs=20, verbose=1)
...
def main():
  # couldnt make the transfer learing model in here bc of error not sure why but works seperatly
  ...
  final_dataset()
  print('made final dataset')
  run_test_harness_final(define_model_final(), "final")

main()

from google.colab import files
files.download('final_model.h5') 
files.download('cnn_1.h5') 
files.download('cnn_2.h5') 
files.download('cnn_3.h5') 
files.download('cnn_3_dropout.h5') 
files.download('cnn_4_aug.h5')
